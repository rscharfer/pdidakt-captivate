...
window.addEventListener("moduleReadyEvent", function (e) {
        ...
        if (collapseTocDom) collapseTocDom.addEventListener('click', function () {
            ...
            if (pd.wasPaused) {
                ...
                if (pd.pausedByUser) {
                    ...
                    console.log('pause shown in collapse!');
                    cp.hide(pd.playButton.si);
                    console.log('play hidden in collapse');
                }
    ...
    pd.addSlideEnterListener = function () {
        ...
        eventEmitterObj.addEventListener('CPAPI_SLIDEENTER', function (e) {
            ...
            // const playVisibilityValue = document.querySelector('#' + pd.playButton.si + 'c').style.visibility;
    ...
    pd.play = function (pause_si, play_si) {
        ...
        cp.hide(play_si);
        console.log('play hidden on play');
        cp.show(pause_si);
        console.log('pause shown on play');
        ...
        //     cp.hide(play_si);
        //     console.log('play hidden after timeout')
        //     cp.show(pause_si);
        //     console.log('pause shown on play after timeout')
        //     window.cpCmndResume = 1;
    ...
    pd.pause = function (pause_si, play_si) {
        ...
        console.log(pause_si);
        cp.hide(pause_si);
        console.log('pause hidden');
        cp.show(play_si);
        console.log('play is ', play_si);
