    ...
    pd = {
        ...
        wireTogglePlayPause: function wireTogglePlayPause(TOCButton, playButton, pauseButton) {
            ...
            function getButton(si, top, left) {
                ...
                if (document.querySelector(id)) return document.querySelector(id);else if (top && bottom) return this.findDOMElementByLocation(top, left);else console.error("A button with id ${id} and top value of ${top} and bottom value of ${left} was not found.");
            }
