...
window.addEventListener("moduleReadyEvent", function (e) {
            ...
            pd.enlargeCollapseButton = function (collapseTocDom) {
            ...
            pd.initialize = function () {
                        ...
                        eventEmitterObj.addEventListener('CPAPI_SLIDEENTER', function (e) {
                                    ...
                                    setTimeout(function () {
                                                ...
                                                var collapseTocDom = pd.getElementByIdOrLocation(pd.collapseButton);
            ...
            pd.wirePlayPauseTocCollapseButtons = function (tocDom, playDom, pauseDom, collapseTocDom) {
